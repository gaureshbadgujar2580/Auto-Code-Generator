...
public class EntryScreen2 extends JPanel
{
	...
	public EntryScreen2()
	{
		...
		//pnlApply.setBackground(ApplyColor.clrMenuSelectPanel);
		...
		pnlEdit.setLayout(new GridLayout(1,1));
		...
		pnlUpdate.setLayout(new GridLayout(1,1));
		...
		pnlDelete.setLayout(new GridLayout(1,1));
		...
		pnlClose.setLayout(new GridLayout(1,1));
		...
		pnlReport.setLayout(new GridLayout(1,1));
		...
		pnlData.setBackground(ApplyColor.clrSubMenuItemsPanel);
		...
		lblProgrammeHeading = new JLabel(ProjectTitle.getProjectTitle(),JLabel.CENTER);
