...
class FrmCodeDeveloper extends JFrame implements ActionListener
{
   ...
   int vGUIEntryID=0;
	...
	FrmCodeDeveloper(ClsProject ObjProject)
	{
		...
		lblProgrammeHeading.setText("GUIEntry Form.. ");
       ...
       // es.ReportAreaSetting(700,550);
		...
		PanelState.enabledComponents(pnlSelectLeft);
	...
	void automateButtons()
	   {
			cbm.manageDataPanel(pnlFormDisplay);
		    ...
		    cbm.manageSecondPanel(pnlProjectUpdate);
			cbm.manageSecondLabel(lblProjectUpdate);
			cbm.manageSecondCombo(cmbProjectUpdate);
			cbm.manageThirdPanel(pnlGUIEntryUpdate);
			cbm.manageThirdLabel(lblGUIEntryUpdate);
			cbm.manageThirdCombo(cmbGUIEntryUpdate);
	...
	public void writeUI(ClsGUIEntry temp)
	{
		...
		ClsProject temp1 = ClsProject.getProjectInformation(vProjectID);
...
/*	void createReport()
	...
	public void writeResult(String writeFileName)
    {
        ...
        try
        {
        	...
        	String Pkgs[]=ClsPackage.getAllPackRecords();
			...
			text="public class "+temp1.getProjectName()+" extends JFrame";
			bufferedWriter.write(text);
			bufferedWriter.newLine();
        	...
        	clsGUIEntry GUIdata[]=clsGUIEntry.getAllGUIEntry(temp1.getProjectID());

			for(clsGUIEntry SingleEle:GUIdata)
			{
					String EleName =clsElement.getNameFromCode(SingleEle.getElementID());
			...
			bufferedWriter.newLine();
				...
				for(clsGUIEntry SingleEle:GUIdata)
				{
					...
					text=SingleEle.getObjectName()+".setForeground(new Color("+
													String.valueOf(SingleEle.getForeRed())+","+
													String.valueOf(SingleEle.getForeGreen())+","+
													String.valueOf(SingleEle.getForeBlue())+
													"));";
					bufferedWriter.write(text);
					bufferedWriter.newLine();
					...
					text=SingleEle.getObjectName()+".setBackground(new Color("+
													String.valueOf(SingleEle.getBackRed())+","+
													String.valueOf(SingleEle.getBackGreen())+","+
													String.valueOf(SingleEle.getBackBlue())+
													"));";
					bufferedWriter.write(text);
					bufferedWriter.newLine();
			...
			text=temp1.getProjectName()+ objName +" =new "+temp1.getProjectName()+"();";
			bufferedWriter.write(text);
			bufferedWriter.newLine();
			...
			text=objName +".setLocation("+String.valueOf(temp1.getXPos())+","+String.valueOf(temp1.getYPos())+");";
			bufferedWriter.write(text);
			bufferedWriter.newLine();
			...
			text=objName +".setSize("+String.valueOf(temp1.getWidth())+","+String.valueOf(temp1.getHeight())+");";
			bufferedWriter.write(text);
			bufferedWriter.newLine();
			...
			text=objName +".setTitle(\""+temp1.getProjectName()+".java\");";
			bufferedWriter.write(text);
			bufferedWriter.newLine();
