...
public class ClsButtonManagement8
{
	...
	void manageSixCombo(JComboBox cmbSix)
	{
		this.cmbSix=cmbSix;
	}
	void manageSixPanel(JPanel pnlSix)
	{
		this.pnlSix=pnlSix;
	}
	void manageSixLabel(JLabel lblSix)
	{
		this.lblSix=lblSix;
	}

	void manageSevenCombo(JComboBox cmbSeven)
	{
		this.cmbSeven=cmbSeven;
	}
	void manageSevenPanel(JPanel pnlSeven)
	{
		this.pnlSeven=pnlSeven;
	}
	void manageSevenLabel(JLabel lblSeven)
	{
		this.lblSeven=lblSeven;
	}

	void manageEightCombo(JComboBox cmbEight)
	{
		this.cmbEight=cmbEight;
	}
	void manageEightPanel(JPanel pnlEight)
	{
		this.pnlEight=pnlEight;
	}
	void manageEightLabel(JLabel lblEight)
	{
		this.lblEight=lblEight;
	}
	...
	void showButtonsOnUI(ButtonState bst)
	 {
		...
		else if(bst.getButtonState()==ButtonState.UpdateState)
		{
			...
			PanelState.disabledComponents(pnlSix);
			PanelState.disabledComponents(pnlSeven);
			PanelState.disabledComponents(pnlEight);
...
void rejectAction()
	...
	void resetAllCombo()
	{
		...
		cmbSix.removeAllItems();
		cmbSix.addItem("No Records...");
		lblSix=new JLabel("-----------------");
		PanelState.disabledComponents(pnlSix);

		cmbSeven.removeAllItems();
		cmbSeven.addItem("No Records...");
		lblSeven=new JLabel("-----------------");
		PanelState.disabledComponents(pnlSeven);

		cmbEight.removeAllItems();
		cmbEight.addItem("No Records...");
		lblEight=new JLabel("-----------------");
		PanelState.disabledComponents(pnlEight);
